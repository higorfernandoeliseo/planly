// const divMenu = document.querySelector('#leftDiv');
// const btnHideView = document.querySelector('#hideLeftBar');
// const divMenu = document.querySelector('.header-Menu');
// const btnHideView = document.querySelector('#btnHideMenu');
// const hideBar = document.querySelector('#leftDiv');

// const btnHideViewMobile = document.querySelector('#hideLeftBar');
...
const divlistsview = document.querySelector('.lists');
...
const ViewLists = async () => {
    ...
    .then((list)=>{
        list.forEach(item => {
            ...
            navList.setAttribute('class','list');
    ...
    .then((task)=> {
        task.forEach(item => {
            ...
            div_task_info.innerHTML = `<span class="listOrigin">
                            ${(item.dueDate ? `<span class="periodTask"><i class="lar la-calendar-check"></i> ${date_task}</span>` : '')} 
